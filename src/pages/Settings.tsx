  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        ...
        <nav className="flex md:flex-col md:w-[200px] shrink-0 bg-bg md:border-r border-b md:border-b-0 border-border p-2 md:p-3 gap-1 overflow-x-auto scrollbar-hide">
          {TAB_CONFIG.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2.5 whitespace-nowrap px-3 py-2 rounded-md text-sm transition cursor-pointer shrink-0 ${
                  isActive
                    ? 'bg-s2 text-text border-b-2 md:border-b-0 md:border-l-2 border-green font-medium'
                    : 'text-muted hover:text-text hover:bg-s1 border-b-2 md:border-b-0 md:border-l-2 border-transparent'
                }`}
              >
                {tab.icon}
                {tab.label}
